...
function Home() {
  ...
  return (
    <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 -mt-11">
            ...
            return (
              <article key={post.id} className="border bg-card text-card-foreground rounded-lg p-3 shadow-sm sm:p-4">
                <header className="mb-3 flex items-start gap-2 sm:gap-3">
                  <div className="h-8 w-8 flex-shrink-0 rounded-full bg-muted flex items-center justify-center text-xs font-medium sm:h-10 sm:w-10 sm:text-sm">
